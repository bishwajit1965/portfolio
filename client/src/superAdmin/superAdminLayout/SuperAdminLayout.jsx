  ...
  return (
    <div className="lg:max-w-full mx-auto">
      <div className="grid lg:grid-cols-12 justify-between">
        ...
        <div
          className={`lg:col-span-2 col-span-6 bg-base-200 rounded-b-sm fixed inset-y-0 left-0 w-64 transform transition-transform duration-300 lg:static lg:translate-x-0 lg:w-auto z-40 ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"}`}
        >
          <SideNav user={user} />
        </div>
