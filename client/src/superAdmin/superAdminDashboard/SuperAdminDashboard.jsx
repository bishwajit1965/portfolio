    ...
    try {
      const fetchData = async () => {
        ...
        if (blogPostsResponse.ok)
          setBlogPostData(await blogPostsResponse.json());
  ...
  return (
    <div className="p-4">
      {loading ? (
        ...
        <div className="admin-dark:text-slate-300 text-slate-700">
          ...
          <div className="grid md:grid-cols-3 gap-4 my-4">
            <div className="bg-white text-slate-700 admin-dark:bg-slate-800 border admin-dark:border-slate-600  p-4 rounded shadow">
            ...
            <div className="bg-white text-slate-700 admin-dark:bg-slate-800 admin-dark:text-slate-300 border admin-dark:border-slate-600 p-4 rounded shadow">
