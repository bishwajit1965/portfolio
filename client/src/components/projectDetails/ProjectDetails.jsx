...
const ProjectDetails = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-12 space-y-12">
      ...
      {/* Main info + image */}
      <div className="grid lg:grid-cols-12 gap-6 bg-base-100 dark:bg-gray-800 rounded-md shadow-md p-4">
        <div className="lg:col-span-6 col-span-12">
          ...
          />
          <figcaption className="text-center text-gray-600 dark:text-gray-400 mt-2 font-medium">
            Main Project Image
          </figcaption>
        </div>
        ...
        <div className="lg:col-span-6 col-span-12 space-y-4">
          ...
          <div className="flex flex-wrap gap-2 items-center">
            <h3 className="flex items-center gap-2 font-semibold bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200 px-3 py-1 rounded-md border border-gray-300 dark:border-gray-600">
              <FaTools /> Tech Stacks
            </h3>
      ...
      {project.screenshots?.length > 0 && (
        <div className="space-y-6">
          <h2 className="flex items-center gap-2 text-2xl font-bold text-gray-800 dark:text-gray-200">
          ...
          {project.screenshots.map((category) => (
            <div key={category.id} className="space-y-2">
              <h3 className="flex items-center gap-2 font-semibold text-gray-700 dark:text-gray-400">
                <FaCircleRight /> {category.category}
              </h3>
                ...
                {category.items.map((item, idx) => (
                  <div key={idx} className="relative group">
                    <img
                      ...
                      alt={item.caption}
                      className="rounded-md w-full h-72 object-cover shadow-md"
                    />
                    {item.caption && (
      ...
      <div className="flex flex-wrap gap-4 mt-6">
        <Link to="/">
          <Button label="Go Home" icon={<FaHome />} variant="outline" />
        </Link>
        <a href="#" target="_blank">
          <Button label="GitHub Source" icon={<FaGithub />} variant="outline" />
        </a>
        <a href="#" target="_blank">
          <Button
            label="Live Demo"
