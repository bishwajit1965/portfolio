...
const CTAButton = ({
  ...
  const baseStyle =
    "px-2 py-1 font-semibold rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 shadow-lg transform transition-transform duration-300 inline-block lg:block text-center";
